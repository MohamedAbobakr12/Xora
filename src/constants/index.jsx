export const features = [
    {
        id: '0',
        icon: 'imgs/feature-1.png',
        caption: 'Easy integration',
        title: 'Work smarter not harder',
        text: "With Xora, tedious tasks are history. Automation and smart processes bring your productivity to new heights. It's like having an extra cup of coffee, but without the jitters.",
        button: {
            icon: 'imgs/magictouch.svg',
            title: 'Watch the demo',
        },
    },
    {
        id: '1',
        icon: 'imgs/feature-2.png',
...
export const details = [
    {
        id: '0',
        icon: 'imgs/detail-1.png',
        title: 'AI automated video editing',
    },
    {
        id: '1',
        icon: 'imgs/detail-2.png',
        title: 'Collaborate with your team',
    },
    {
        id: '2',
        icon: 'imgs/detail-3.png',
        title: 'Ultra fast cloud-engine',
    },
    {
        id: '3',
        icon: 'imgs/detail-4.png',
...
export const plans = [
    {
        ...
        icon: 'imgs/circle.svg',
        logo: 'imgs/plan-1.png',
    },
    {
        id: '1',
        title: 'Overdrive',
        ...
        icon: 'imgs/triangle.svg',
        logo: 'imgs/plan-2.png',
    },
    {
        id: '2',
        title: 'Team',
        ...
        icon: 'imgs/hexagon.svg',
        logo: 'imgs/plan-3.png',
    },
];
...
export const testimonials = [
    {
        ...
        role: 'Globalnomads',
        avatarUrl: 'imgs/testimonials/jessica-saunders.png',
        comment:
    ...
    },
    {
        ...
        avatarUrl: 'imgs/testimonials/mark-erixon.png',
        comment:
    ...
    },
    {
        ...
        name: 'Melanie Hurst',
        role: 'Cyberleap',
        avatarUrl: 'imgs/testimonials/melanie-hurst.png',
        comment:
    ...
    },
    {
        ...
        name: 'Alicia Barker',
        role: 'Cyberleap',
        avatarUrl: 'imgs/testimonials/alicia-barker.png',
        comment:
    ...
    },
    {
        ...
        name: 'Becky Snider',
        role: 'Floclips',
        avatarUrl: 'imgs/testimonials/becky-snider.png',
        comment:
    ...
    },
    {
        ...
        name: 'Jim Bradley',
        role: 'Vid capital intl',
        avatarUrl: 'imgs/testimonials/jim-bradley.png',
        comment:
